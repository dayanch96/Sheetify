!(function (t, e) {
  ...
  function s(t, e) {
    ...
    for (const [t, n] of Object.entries(e))
      if ("children" === t && n) for (const [t, e] of Object.entries(n)) e instanceof Node ? i.appendChild(e) : "string" == typeof e ? i.appendChild(document.createTextNode(e)) : i.appendChild(s(t, e));
  ...
  class h extends e {
    ...
    initHtml() {
      ...
      if (this.options.cspNonce && typeof this.options.cspNonce === "string") {
        style.nonce = this.options.cspNonce.replace(/"/g, "");
      }
      style.textContent = `
        :host {
          user-select: none;
      ...
      scrollDiv.setAttribute("part", "scroll");
      const wrapperDiv = document.createElement("div");
      wrapperDiv.className = "wrapper";
      wrapperDiv.setAttribute("part", "wrapper");
      const canvasesDiv = document.createElement("div");
      canvasesDiv.className = "canvases";
      canvasesDiv.setAttribute("part", "canvases");
      canvasesDiv.style.minHeight = `${this.getHeight(
        this.options.height,
        this.options.splitChannels
      )}px`;
      const progressDiv = document.createElement("div");
      progressDiv.className = "progress";
      progressDiv.setAttribute("part", "progress");
      const cursorDiv = document.createElement("div");
      cursorDiv.className = "cursor";
      cursorDiv.setAttribute("part", "cursor");
      wrapperDiv.appendChild(canvasesDiv);
